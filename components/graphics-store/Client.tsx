    ...
    <main>
        <div>
          <div className='relative'>
            ...
            <div className="flex flex-col gap-2 absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] text-center text-white font-PoppinsLight">
              <h1 className="uppercase font-FamiljenBold text-[1.3rem] tracking-tighter w-full lg:text-[6rem]">Graphic Store</h1>
              <p className="font-Poppins w-full text-[0.8rem] lg:text-[1rem]">Get the best designs at an affordable rate!</p>
              <SearchComponent />
            </div>
