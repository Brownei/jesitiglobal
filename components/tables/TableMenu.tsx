...
import { GraphicColumn } from "../admin-dashboard/graphics/columns"
...
const TableMenu: FC<GraphicColumnProps> = ({item, navigationSection}) => {
    ...
    <div>
      <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem onClick={() => router.push(`/dashboard/products/${item.name}`)} className="flex items-center gap-1">
